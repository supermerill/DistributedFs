...
//		root.setUID(myFuseManager.getContext().uid.get());
//		root.setGID(myFuseManager.getContext().gid.get());
//		root.createSubDir("dir1");
//		root.getDir("dir1").setUID(myFuseManager.getContext().uid.get());
//		root.getDir("dir1").setGID(myFuseManager.getContext().gid.get());
//		root.createSubDir("dir2");
//		root.getDir("dir2").setUID(myFuseManager.getContext().uid.get());
//		root.getDir("dir2").setGID(myFuseManager.getContext().gid.get());
//		root.getDir("dir2").createSubDir("dir21");
//		FsFic f = (FsFic) root.getDir("dir1").createSubFile("fic1");
//		f.setUID(myFuseManager.getContext().uid.get());
//		f.setGID(myFuseManager.getContext().gid.get());
